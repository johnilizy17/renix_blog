...
import { loginAuth } from "../../services/authBlog";
...
export default function LoginEmail() {
    ...
    const submit = async () => {
        ...
        if (!formik.dirty) {
            ...
            localStorage.clear();
            try {
                response = await loginAuth(JSON.stringify(formik.values));
                if (response) {
    ...
    return (
        <>
                ...
                <div className="w-full h-auto pt-2">
                    {formik.touched.email && formik.errors.email && (
                        <motion.p
                            ...
                            className="text-xs font-Inter-Medium text-[#1DA1F2]"
                        >
                            {formik.errors.email}
                        </motion.p>
                    )}
            ...
            <button
                className=" underline text-[#1DA1F2] text-sm mt-2 mb-4 ml-auto font-semibold "
                onClick={() => {
                    navigate.push("/auth/forgotten_password");
                }}
            >
                Forgot password?
            </button>
            ...
            <p className=" text-sm text-center mt-6 font-medium ">
                ...
                <span
                    ...
                    className=" text-[#1DA1F2] cursor-pointer ml-1 font-bold "
                >
                    Sign Up
                </span>
            </p>
